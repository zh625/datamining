...
def train_and_evaluate(models, results_dict):
    for name, model in models.items():
        ...
        results_dict[name] = {
            ...
            "ROC-AUC": roc_auc,
            "Confusion Matrix": str(conf_matrix.tolist()),
...
results_df.to_csv("model_results_with_class_report.csv")

print("Model development completed. Results saved to 'model_results_with_class_report.csv'.")
